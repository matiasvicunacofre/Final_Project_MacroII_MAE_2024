...
M_.block_structure_stat.block(2).variable = [ 3 6 1 2 4 8];
...
M_.block_structure_stat.variable_reordered = [ 5 3 6 1 2 4 8 9 7];
...
M_.block_structure_stat.block(2).g1_sparse_rowval = int32([1 4 2 3 1 3 5 2 4 6 1 2 4 5 5 6 ]);
M_.block_structure_stat.block(2).g1_sparse_colval = int32([1 1 2 2 3 3 3 4 4 4 5 5 5 5 6 6 ]);
M_.block_structure_stat.block(2).g1_sparse_colptr = int32([1 3 5 8 11 15 17 ]);
...
oo_.steady_state(1) = (-0.2231435513142097);
oo_.steady_state(2) = 2.302585092994046;
oo_.steady_state(7) = 0;
oo_.steady_state(8) = (-1.6094379124341);
oo_.steady_state(6) = (-3.218875824868201);
oo_.steady_state(5) = 0;
oo_.steady_state(3) = (-1.09861228866811);
if M_.exo_nbr > 0
