...
if nargout > 3
    g1_v = NaN(16, 1);
g1_v(1)=T(1)*params(6);
g1_v(2)=T(10)-(y(6)+1-params(3))*params(1)*T(10);
g1_v(3)=T(1);
g1_v(4)=(-((-(params(4)*T(2)*T(4)))/(T(4)*T(4))));
g1_v(5)=(-(T(8)*T(6)*T(4)*getPowerDeriv(T(4),params(4),1)));
g1_v(6)=T(4)-(1-params(3))*T(4);
g1_v(7)=1;
g1_v(8)=(-(T(5)*params(1)));
g1_v(9)=(-((-((1-params(4))*T(2)*T(3)))/(T(3)*T(3))));
g1_v(10)=(-(T(7)*T(3)*getPowerDeriv(T(3),1-params(4),1)));
