...
[T_order, T] = Modelo_Benchmark.sparse.dynamic_g1_tt(y, x, params, steady_state, T_order, T);
g1_v = NaN(28, 1);
...
g1_v(6)=(-(exp(y(10))*params(6)/exp(1-y(12))));
g1_v(7)=exp(y(10));
g1_v(8)=exp(y(11));
g1_v(9)=(1-params(4))*T(2)*(-y(13))/(y(12)*y(12))-exp(y(10))*(-(params(6)*(-exp(1-y(12)))))/(exp(1-y(12))*exp(1-y(12)));
g1_v(10)=(-(T(3)*exp(y(12))*getPowerDeriv(exp(y(12)),1-params(4),1)));
g1_v(11)=(-((1-params(4))*T(2)*(-y(13))/(y(12)*y(12))));
g1_v(12)=(-(T(2)*(-y(13))/(y(12)*y(12))));
g1_v(13)=(1-params(4))*T(2)*1/y(12);
g1_v(14)=(-(params(4)*exp(y(13))/exp(y(2))));
g1_v(15)=exp(y(13));
g1_v(16)=(-exp(y(13)));
g1_v(17)=(-((1-params(4))*T(2)*1/y(12)));
g1_v(18)=(-(T(2)*1/y(12)));
g1_v(19)=1;
g1_v(20)=(-(T(3)*T(4)));
g1_v(21)=1;
