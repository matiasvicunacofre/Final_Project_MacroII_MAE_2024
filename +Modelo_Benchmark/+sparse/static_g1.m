...
[T_order, T] = Modelo_Benchmark.sparse.static_g1_tt(y, x, params, T_order, T);
g1_v = NaN(24, 1);
g1_v(1)=T(5)-(y(6)+1-params(3))*params(1)*T(5);
g1_v(2)=(-(exp(y(1))*params(6)/exp(1-y(3))));
g1_v(3)=exp(y(1));
...
g1_v(7)=(1-params(4))*T(2)*(-y(4))/(y(3)*y(3))-exp(y(1))*(-(params(6)*(-exp(1-y(3)))))/(exp(1-y(3))*exp(1-y(3)));
g1_v(8)=(-(T(3)*exp(y(3))*getPowerDeriv(exp(y(3)),1-params(4),1)));
g1_v(9)=(-((1-params(4))*T(2)*(-y(4))/(y(3)*y(3))));
g1_v(10)=(-(T(2)*(-y(4))/(y(3)*y(3))));
g1_v(11)=(1-params(4))*T(2)*1/y(3);
g1_v(12)=(-(params(4)*exp(y(4))/exp(y(2))));
g1_v(13)=exp(y(4));
g1_v(14)=(-exp(y(4)));
g1_v(15)=(-((1-params(4))*T(2)*1/y(3)));
g1_v(16)=(-(T(2)*1/y(3)));
g1_v(17)=1-params(2);
g1_v(18)=(-(T(3)*T(4)));
