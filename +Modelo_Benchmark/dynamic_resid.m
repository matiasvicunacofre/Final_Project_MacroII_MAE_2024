...
if T_flag
    T = Modelo_Benchmark.dynamic_resid_tt(T, y, x, params, steady_state, it_);
end
residual = zeros(9, 1);
    residual(1) = (exp(y(3))^(-1)) - (T(1)*(y(13)+1-params(3)));
    residual(2) = ((1-params(4))*T(2)) - (exp(y(3))*params(6)/exp(1-y(5)));
    ...
    residual(8) = (exp(y(9))) - ((1-params(4))*T(2));
    residual(9) = (y(11)) - (T(2));
